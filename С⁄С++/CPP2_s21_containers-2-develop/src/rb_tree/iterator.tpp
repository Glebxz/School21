...
class BinaryTree<Key, Val, Compare>::BinaryTreeIterator {
 private:
...
template <typename Key, typename Val, typename Compare>
bool BinaryTree<Key, Val, Compare>::BinaryTreeIterator::operator==(
...
template <typename Key, typename Val, typename Compare>
typename BinaryTree<Key, Val, Compare>::value_type &
BinaryTree<Key, Val, Compare>::BinaryTreeIterator::operator*() {
  value_type &rtrn_value = current_node_ptr_->value_;
  return rtrn_value;
}
